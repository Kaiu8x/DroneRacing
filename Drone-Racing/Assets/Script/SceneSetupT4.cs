...
public class SceneSetupT4 : MonoBehaviour
{
  ...
  public GameObject checkpoint19;
  public GameObject checkpoint20;
  public GameObject checkpoint21;
  ...
  private void createPlayers()
  {
    ...
    for (int i = 0; i < numPlayers; i++)
    {
      ...
      tmpPlayer.transform.Rotate(0f, 90.0f,0f);
